...
export class EmployeeComponent implements OnInit {
  ...
  //This functions get fired when all this component is fully loaded
  ngOnInit() {
    this.resetForm();
    this.refreshEmployeeList();
  }

  //form parameter as type NgForm and it is null "?" as this function will be called from various 
